...
function getFormFields($data)
	...
	function penyebut($nilai) {
		...
		$huruf = array("", "satu", "dua", "tiga", "empat", "lima", "enam", "tujuh", "delapan", "sembilan", "sepuluh", "sebelas");
		$temp = array();
		if ($nilai < 1000000 && $nilai>=10000) {
			$temp['nilai'] = number_format($nilai/1000,1,'.',',');
			$temp['satuan']="RIBU";
		} else if ($nilai < 1000000000 && $nilai>=1000000) {
			$temp['nilai'] = number_format($nilai/1000000,1,',','.');
			$temp['satuan']="JUTA";
		} else if ($nilai < 1000000000000 && $nilai>=1000000000) {
			$temp['nilai'] = number_format($nilai/1000000000,1,',','.');
			$temp['satuan']="MILYAR";
		} else if ($nilai < 1000000000000000 && $nilai>=1000000000000) {
			$temp['nilai'] = number_format($nilai/1000000000000,1,',','.');
			$temp['satuan']="TRILYUN";
		}  
		else
		{
