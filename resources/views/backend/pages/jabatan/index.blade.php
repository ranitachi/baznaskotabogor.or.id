...
@section('title')
	<title>Jabatan | Badan Amil Zakat Nasional (BAZNAS) Kota Bogor</title>
@stop
...
$(document).ready(function(){
  ...
  loadData(-1);
	...
	$('button#confirmbutton').click(function(){
        ...
        type:form_method,
        url: form_action,
        data:$('form#form-jabatan').serialize()
    }).done(function(data){
        // getPageData();
				if(form_method=="PUT")
					var txt = "Data Jabatan Berhasil Di Edit";
				else
					var txt = "Data Jabatan Berhasil Di Tambah";
        ...
        $('#modal-confirm').modal('hide');
		            ...
		            type: 'success'
						...
						loadData(-1);
		    // alert('Data Jabatan Berhasil Di Tabah');
        // toastr.success('Item Created Successfully.', 'Success Alert', {timeOut: 5000});
    }).fail(function(){
			$('#modal-confirm').modal('hide');
			new PNotify({
					title: 'Informasi',
					text: 'Simpan Data Jabatan Gagal',
...
function loadData(id)
{
  ...
  $('div#data').load(APP_URL+'/jabatan-data/'+id,function(){
    $('div#data-loader').hide();
    $('table#data-jabatan').DataTable({
			autoWidth: false,
...
function hapus(id)
{
	...
	$('#hapusbutton').click(function(){
        ...
        $('#modal-hapus').modal('hide');
				    new PNotify({
		            title: 'Berhasil',
		            text: 'Data Jabatan Berhasil Di Hapus',
		            addclass: 'alert bg-success alert-styled-right',
		            type: 'success'
		        });
						loadData(-1);
...
function form(id)
{
	...
	$('div#dynamic-content-confirm').load(APP_URL+'/jabatan-form/'+id,function(){
