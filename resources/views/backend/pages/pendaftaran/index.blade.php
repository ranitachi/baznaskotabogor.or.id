...
@section('title')
	<title>Data Pendaftaran | Badan Amil Zakat Nasional (BAZNAS) Kota Bogor</title>
@stop
...
function loadData(id)
{
  ...
  $('div#data').load(APP_URL+'/pendaftaran-data/'+id,function(){
...
function hapus(id)
{
	...
	$('#hapusbutton').click(function(){
        ...
        $('#modal-hapus').modal('hide');
				    new PNotify({
		            title: 'Berhasil',
		            text: 'Proses Pendaftaran Berhasil Di Hapus',
		            addclass: 'alert bg-success alert-styled-right',
		            type: 'success'
		        });
						loadData(-1);
        ...
        // toastr.success('Item Created Successfully.', 'Success Alert', {timeOut: 5000});
			...
			new PNotify({
					title: 'Informasi',
					text: 'Hapus Data Proses Pendaftaran Gagal',
      ...
      <ul class="fab-menu-inner">
				<li>
					<div data-fab-label="Tambah Data">
						<a href="{{URL::to('/pendaftaran-form/-1')}}" class="btn btn-default btn-rounded btn-icon btn-float">
