...
@section('title')
	<title>Bagian | Badan Amil Zakat Nasional (BAZNAS) Kota Bogor</title>
@stop
...
$(document).ready(function(){
  ...
  loadData(-1);
	...
	$('button#confirmbutton').click(function(){
        ...
        type:form_method,
        url: form_action,
        data:$('form#form-bagian').serialize()
    }).done(function(data){
        // getPageData();
        if(form_method=="PUT")
          var txt = "Nama Bagian Berhasil Di Edit";
        else
          var txt = "Nama Bagian Berhasil Di Tambah";
...
function loadData(id)
{
  ...
  $('div#data').load(APP_URL+'/bagian-data/'+id,function(){
    $('div#data-loader').hide();
    $('table#data-bagian').DataTable({
			autoWidth: false,
...
function hapus(id)
{
	...
	$('#hapusbutton').click(function(){
        ...
        $('#modal-hapus').modal('hide');
				    new PNotify({
		            title: 'Berhasil',
		            text: 'Data Bagian Berhasil Di Hapus',
		            addclass: 'alert bg-success alert-styled-right',
		            type: 'success'
		        });
						loadData(-1);
...
function form(id)
{
	...
	$('div#dynamic-content-confirm').load(APP_URL+'/bagian-form/'+id,function(){
...
<ul class="fab-menu fab-menu-fixed fab-menu-bottom-right" data-fab-toggle="hover">
    <li>
      ...
      <ul class="fab-menu-inner">
				<li>
					<div data-fab-label="Tambah Data Bagian">
						<a href="javascript:tambahBagian()" class="btn btn-default btn-rounded btn-icon btn-float">
