<form action="{{URL::to('layanan/'.$id)}}" method="POST" id="form-jemput" class="send_message">
   ...
   <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="col-xs-12">
        <textarea placeholder="Keterangan"  class="form-control" rows="4" name="keterangan"></textarea>
    </div>
